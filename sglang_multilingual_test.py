#!/usr/bin/env python3
"""
SGLang Multilingual Test - Force generation in Chinese, Korean, and English
"""
...
def test_sglang_multilingual(max_tokens=3000):
    """Test SGLang with explicit multilingual prompts - same as vLLM"""
    url = "http://localhost:8000/v1/completions"

    # Same explicit multilingual prompt as vLLM test
...
"""
    ...
    print("="*60)
    print("Testing SGLang with Explicit Multilingual Prompt")
    print("="*60)
    ...
    try:
        ...
        output_file = f"/home/qwen-8b-repo/sglang_multilingual_{timestamp}.txt"
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write(f"SGLang Multilingual Test Results\n")
...
if __name__ == "__main__":
    print("⏳ Waiting 60 seconds for SGLang to fully initialize...")
    time.sleep(60)

    # Test with explicit prompt
    result = test_sglang_multilingual(max_tokens=3000)

    if result:
        print(f"\n{'='*60}")
        print("📊 FINAL SUMMARY - SGLang")
        print(f"{'='*60}")
